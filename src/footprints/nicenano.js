  ...
  body: p => {
    ...
    function pins(def_neg, def_pos) {
      return `
        ...
        ${''/* pin names */}
        (fp_text user RAW (at -13.97 ${def_pos}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user GND (at -11.43 ${def_pos}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user RST (at -8.89 ${def_pos}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user VCC (at -6.35 ${def_pos}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P21 (at -3.81 ${def_pos}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P20 (at -1.27 ${def_pos}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P19 (at 1.27 ${def_pos}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P18 (at 3.81 ${def_pos}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P10 (at 6.35 ${def_pos}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P14 (at 8.89 ${def_pos}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P16 (at 11.43 ${def_pos}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P10 (at 13.97 ${def_pos}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
      
        (fp_text user P01 (at -13.97 ${def_neg}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P00 (at -11.43 ${def_neg}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user GND (at -8.89 ${def_neg}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user GND (at -6.35 ${def_neg}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P02 (at -3.81 ${def_neg}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P03 (at -1.27 ${def_neg}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P04 (at 1.27 ${def_neg}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P05 (at 3.81 ${def_neg}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P06 (at 6.35 ${def_neg}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P07 (at 8.89 ${def_neg}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P08 (at 11.43 ${def_neg}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P09 (at 13.97 ${def_neg}7.62 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))

        (fp_text user P101 (at 8.89 ${def_neg}5.08 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P102 (at 8.89 ${def_neg}2.54 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        (fp_text user P107 (at 8.89 ${def_neg}0.0 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.4 0.4) (thickness 0.10))))
        ...
        (pad 25 thru_hole circle (at 8.89 ${def_neg}5.08 0) (size 1.7526 1.7526) (drill 1.0922) (layers *.Cu *.SilkS *.Mask) ${p.net.P101.str})
        (pad 26 thru_hole circle (at 8.89 ${def_neg}2.54 0) (size 1.7526 1.7526) (drill 1.0922) (layers *.Cu *.SilkS *.Mask) ${p.net.P102.str})
        (pad 27 thru_hole circle (at 8.89 ${def_neg}0.0 0) (size 1.7526 1.7526) (drill 1.0922) (layers *.Cu *.SilkS *.Mask) ${p.net.P107.str})
      `
    }
